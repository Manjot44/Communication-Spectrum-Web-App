...
manjot	manjot	$2b$10$yj.bS.y91e8YcZjvX8/12eCPAbg6HLWW7F2VAcsRez49JRMfj5sve	Australia	2024-01-01	Speech Therapist	2222	f
\.
...
COPY public."Supports" (support_id, type, title, title_img, date, step_img, step_names, step_times, category, layout, prof_id) FROM stdin;
\.
