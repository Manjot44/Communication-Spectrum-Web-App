...
function ChoiceBoardStepHorizontal ({ image, setImage, index, deleteImage, removeStep, setName, stepName, setTime, stepTime }) {
				...
				<Grid item xs={12} style={{ borderRadius: '0 0 15px 15px' }}>
					...
					<Grid container spacing={0}>
						<Grid item xs={12} md={9} style={{ backgroundColor: 'white' }}>
							<Box sx={{ height: '200px', width: '1000px' }} style={{ padding: '0 15px', alignItems: "center", justifyContent: "center" }}>
								<div>
									<br/>
									<TextField
										label="Step Name"
						...
						<Grid item xs={12} md={3} style={{ backgroundColor: 'white' }}>
							<Box sx={{ height: '600px', width: '600px' }} style={{ padding: '5px 5px' }}>
